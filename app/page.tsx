...
const placementOptions: PlacementStatus[] = ["Not placed", "Placed"];
const DEFAULT_CLIENT_MESSAGE01 = "Hello {name} from LAYLA Doha, your {service} appointment is scheduled for {date} at {time}.";
